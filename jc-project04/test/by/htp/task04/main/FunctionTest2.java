...
public class FunctionTest2 {
	...
	public void calcSubctract() {
		...
		Assert.assertEquals(expectedSubctract.getReal(), actualSubctract.getReal(), 0.00000001);
		Assert.assertEquals(expectedSubctract.getImaginary(), actualSubctract.getImaginary(), 0.00000001);
	}
